...
@section('admin-config')
  ...
  <div class="alert alert-warning"><strong>Warning:</strong> This panel is still WIP and might not work 100%, if at all.
  </div>
  @set($url, str_replace(request()->path(), '', request()->url()))
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title">Routes
        <small>(Make sure paths have the trailing slash)</small>
      </h3>
    </div>
