...
//BaseModel implements Caller, AuthenticatableContract, CanResetPasswordContract
class Staff extends Authenticatable
{
    ...
    protected $fillable = ['id', 'username', 'name', 'password', 'salt', 'email', 'verified_at', 'disabled_at'];
